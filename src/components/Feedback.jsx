  ...
  const user = [
    {
      ...
      feedback:
        "The streaming quality is consistently excellent, even on my older laptop. I appreciate the high-resolution trailers. However, the movie descriptions could be more detailed, especially for independent films",
    },
    {
      name: "Messi",
      image:
        "https://cdn.resfu.com/img_data/players/medium/23569.jpg?size=340x&lossy=1",
      feedback:
        "I found the curated lists to be very well-selected. The interface is clean, making it easy to find quality films. I'd like to see more critical reviews integrated into the movie pages, not just user ratings.",
    },
    {
      name: "G-Devith",
      image:
        "https://cdn-images.dzcdn.net/images/cover/e467d4413c6aa2392f5bc1b4e13cde6f/0x1900-000000-80-0-0.jpg",
      feedback:
        "The organization of the classic film section is superb. The video encoding is top-notch, with clear audio. I think the website could benefit from highlighting behind-the-scenes content or director interviews for some of the featured films.",
    },
    {
      name: "Ronaldo",
      image:
        "https://s3.ap-south-1.amazonaws.com/assets.ynos.in/investor-profile-photos/I_7000682.jpg",
      feedback:
        "The site loads quickly, and the mobile experience is smooth. The image quality for thumbnails and posters is very high. I think adding more information about the restoration process for older films would be a great addition.",
    },
  ];
  return (
    <>
        ...
        <main className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {user.map((data, idx) => (
              <div
                key={idx}
                className="bg-gray-800/50 backdrop-blur-lg rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:transform hover:-translate-y-2 border border-gray-700/30 flex flex-col"
              >
