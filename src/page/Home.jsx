...
export default function HomePage() {
  return (
    <>
      <section className="relative md:w-full sm:w[1000px] md:h-auto sm:h-auto h-[400px] bg-no-repeat mt-10  rounded-3xl bg-cover bg-[url('https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/f562aaf4-5dbb-4603-a32b-6ef6c2230136/dh0w8qv-9d8ee6b2-b41a-4681-ab9b-8a227560dc75.jpg/v1/fill/w_1280,h_720,q_75,strp/the_netflix_login_background__canada__2024___by_logofeveryt_dh0w8qv-fullview.jpg?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..LOYKSxIDqfPwWHR0SSJ-ugGQ6bECF0yO6Cmc0F26CQs')] px-4 py-28 gap-12 text-gray-600 md:px-8">
        ...
        <div className="space-y-5 max-w-4xl  mx-auto text-center relative">
          ...
          <h2 className="sm:text-2xl text-2xl text-white font-extrabold mx-auto md:text-5xl">
            Welcome to the{" "}
